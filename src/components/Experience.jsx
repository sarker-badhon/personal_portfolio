    ...
    <div className="">
      <div className=" my-8" id="experience">
        <div className="lg:mr-[150px] lg:ml-[150px] px-5 lg:py-10">
          ...
          <h3 className='text-4xl font-bold border-b-4 border-gray-500 py-2 mb-6 text-center'> My
          ...
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 text-center">
            {techs.map(({ id, src, title, style }) => (
              ...
              className={`shadow-md hover:scale-105 duration-500 py-2 rounded-lg ${style}`} key={id}>
