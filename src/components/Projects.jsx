        ...
        <div className=" w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:w-full gap-4">
            ...
            <div className="h-fit w-full p-4 bg-slate-700 ">
              <img src="https://i.ibb.co/xqDzkt9/investogain.png" alt="Top Chef App" className="h-[270px] border  border-blue-600 rounded-lg  shadow-t-xl hover:scale-105 lg:w-full object-fit " />
              <h3 className="text-xl my-4">Investo-Gain  Application</h3>
              <div className="flex gap-3">
                <a
                  href="https://github.com/sarker-badhon/InvestoGain-project" 
                  target="_blank"
                  rel="noreferrer"
                  className="text-white bg-pink-500 rounded px-2 py-1 inline-block"
                >
                  Github
                </a>
                <a
                  href="https://magenta-jelly-439af3.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
            ...
            <div className="h-fit w-full p-4 bg-slate-700 ">
              <img src={hireMe} alt="Top Chef App" className="h-[270px] border  border-blue-600 rounded-lg  shadow-t-xl hover:scale-105 lg:w-full object-fit " />
            ...
            <img src={yoga_zone} alt="Top Chef Application" className="h-[270px] border  border-blue-600 rounded-lg  shadow-t-xl hover:scale-105" />
            ...
            <img src={teddy_bear} alt="Teddy_bear Application" className="h-[270px] border  border-blue-600 rounded-lg  shadow-t-xl object-fit" />
            <img src={teddy_bear} alt="Teddy_bear Application" className="h-[270px] border  border-blue-600 rounded-lg  shadow-t-xl " />
            </div>
